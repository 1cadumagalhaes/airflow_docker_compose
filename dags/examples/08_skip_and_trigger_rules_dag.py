...
from airflow.sdk import BaseOperator, TriggerRule, dag
...
@dag(
    ...
    dag_id='skip_and_trigger_rules',
    dag_display_name='08 - Skip and Trigger Rules',
